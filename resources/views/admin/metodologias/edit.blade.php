...
@section('content')
    ...
    {!! Form::model($metodologia, ['method' => 'PUT', 'route' => ['admin.metodologias.update', $metodologia->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($metodologia->imagem)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$metodologia->imagem) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$metodologia->imagem) }}"></a>
                    @endif
