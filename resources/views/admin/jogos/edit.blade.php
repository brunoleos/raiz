...
@section('content')
    ...
    {!! Form::model($jogo, ['method' => 'PUT', 'route' => ['admin.jogos.update', $jogo->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($jogo->imagem)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$jogo->imagem) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$jogo->imagem) }}"></a>
                    @endif
