...
@section('content')
    ...
    {!! Form::model($familia, ['method' => 'PUT', 'route' => ['admin.familias.update', $familia->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($familia->foto)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$familia->foto) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$familia->foto) }}"></a>
                    @endif
